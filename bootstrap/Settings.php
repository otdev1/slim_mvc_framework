...
class Settings
{
    ...
    /**
     * Set a key on application config i.e add additional elements to the config
     * array
    ...
    public function configureEnvironment()
    {
        ...
        $config['environment'] = $_ENV['ENVIRONMENT'];
